                    ...
                    <Card className="h-100 shadow-sm">
                        <Card.Body>
                            <Card.Title className="d-flex justify-content-between align-items-start">
                                ...
                                <Badge 
                                    bg={group.visibility === 'public' ? 'success' : 'warning'}
                                    className="ms-2"
                                >
                                    {group.visibility === 'public' ? 'Public' : 'Request to Join'}
                                </Badge>
                            </Card.Title>
                            ...
                            <div className="mb-2">
                                <Badge bg="secondary" className="me-1">{group.institution}</Badge>
                                <Badge bg="info">{group.term}</Badge>
                            </div>
                            <div className="d-flex justify-content-between align-items-center">
                                <span className="text-muted">
                                    <i className="bi bi-people"></i> {group.current_members}/{group.max_members}
                                </span>
                                <Button 
